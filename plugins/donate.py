...
async def donate(client, message):
  ...
  await client.send_message(message.chat.id, text="A chunga Donate tih button hi hmet la min ṭanpui na'n i donate thei ang. Emaw, a hnuaia link hi join la, tah khan donate dan chidang deuh pawh a en theih ang.\n\nhttps://t.me/teamtereuhte", reply_to_message_id=message.id, disable_web_page_preview=True)
  return
