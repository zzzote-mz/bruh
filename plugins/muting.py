...
async def unmute(client, message):
    if not message.reply_to_message and len(message.command) == 1:
       ...
       return
        ...
        await client.send_message(chat_id=message.chat.id, text=f"{umun} hi Mute anihna hlih sak ani e.", reply_to_message_id=message.message_id)
        return
    else:
        ...
        await client.send_message(chat_id=message.chat.id, text=f"{umuns} hi Mute anihna hlih sak ani e.", reply_to_message_id=message.message_id)
        return
